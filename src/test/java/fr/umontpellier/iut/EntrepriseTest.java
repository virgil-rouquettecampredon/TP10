...
class EntrepriseTest {
    ...
    @Test
    void getEmployes() {
        entreprise.embaucher(e1, LocalDate.of(2018, 04, 10));
        entreprise.embaucher(e2, LocalDate.of(2018, 05, 10));
        entreprise.embaucher(e3, LocalDate.of(2018, 04, 10));
        entreprise.embaucher(e4, LocalDate.of(2018, 07, 10));
    ...
    void distribuerBonus(){
        entreprise.embaucher(e1, LocalDate.of(2014, 04, 10));
        entreprise.embaucher(e2, LocalDate.of(2012, 05,10));
        entreprise.embaucher(e3, LocalDate.of(2016, 04, 10));
        entreprise.embaucher(e4, LocalDate.of(2011, 07, 10));
    ...
    void remercier(){
        ...
        assertEquals(2, entreprise.getLePersonnel().size());
        assertTrue(entreprise.getLePersonnel().contains(e2));
        assertTrue(entreprise.getLePersonnel().contains(e4));
    }
}